...
const LoginRegister = () => {
    ...
    const handleLogin = async (e) => {
        ...
        setErrorMessage('');
        try {
            const response = await fetch('https://backend-production-7345.up.railway.app/api/users/login', {
                method: 'POST',
    ...
    const handleRegister = async (e) => {
        e.preventDefault();
        try {
            const response = await fetch('https://backend-production-7345.up.railway.app/api/users/register', {
                method: 'POST',
